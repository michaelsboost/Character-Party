var str, ranMood, ranJob, ranJSONItem, grabJSObj, grabItem, output, 
    ...
    jobsJSON    = [
      ...
      "Clerical and Office Support Workers (not covered elsewhere)",
      "Clerks (Accounting)",
      "Clerks (Betting)",
      ...
      "Concierges (Hotel Service Managers)",
      ...
      "Cotton Growers",
      "Councillor",
      "Counselling Psychologists (Other Psychologists)",
      "Counsellors",
      "Couriers",
      ...
      "Criminologist (Other Social Professionals)",
      "Crop Farm Workers",
      "Crop Farmers",
