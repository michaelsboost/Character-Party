...
function searchWeb(val) {
  return " <a class=\"whitetxt\" href=\"javascript:window.open('https://duckduckgo.com/?q="+ val.toLowerCase().replace(/ /, '+') +"%3F&t=h_&ia=web', '_system')\" data-html2canvas-ignore=\"true\"><i class=\"fa fa-external-link\"></i></a>";
}

// search images
function searchImages(val) {
  return " <a class=\"whitetxt\" href=\"javascript:window.open('https://duckduckgo.com/?q="+ val.toLowerCase().replace(/ /, '+') +"&t=h_&iax=images&ia=images', '_system')\" data-html2canvas-ignore=\"true\"><i class=\"fa fa-external-link\"></i></a>";
}
...
download.onclick = function() {
  ...
  filename = filename.substring(0, filename.length - 1) + ".png";
  ...
  html2canvas(grablog, {
    ...
    myBase64 = canvas.toDataURL("image/png").replace("image/png", "image/octet-stream");
